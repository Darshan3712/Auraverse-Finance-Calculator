...
export default function VehicleLoan() {
    const [loanAmount, setLoanAmount] = useState(800000); // Default 8 Lakhs
    const [rate, setRate] = useState(9.0); // Default 9% (standard car loan)
    ...
    return (
        <div className="calc-container">
            <h1 className="calc-title">🚗 Vehicle Loan Calculator</h1>
            <p className="calc-subtitle">Calculate monthly EMIs and interest payouts for your new or pre-owned car/two-wheeler loan purchase.</p>

            <div className="calc-grid">
                <div className="card">
                    <div className="card-title">Loan Details</div>
                    <SliderInput label="Loan Amount" value={loanAmount} onChange={setLoanAmount} min={50000} max={10000000} step={25000} unit="₹" />
                    <SliderInput label="Annual Interest Rate" value={rate} onChange={setRate} min={7.0} max={20.0} step={0.1} unit="%" />
            ...
            <div className="info-box">
                💡 <strong>Hypothecation note:</strong> During the loan tenure, the vehicle is hypothecated to the bank/lender. Once the loan is fully repaid, you will receive a No Objection Certificate (NOC) to remove hypothecation from the RTO registration.
            </div>
